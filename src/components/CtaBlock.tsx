  ...
  return (
    <section className={`cta-block py-20 ${bgColors[backgroundColor]}`} data-tenant={tenant}>
      <div className="container mx-auto px-4 text-center">
        ...
        <a
          href={buttonLink}
          className={`inline-block px-8 py-3 bg-white ${backgroundColor === 'dark' ? 'text-gray-900' : 'text-blue-600'} font-semibold rounded-lg shadow-lg transition-all ${hoverColors[backgroundColor]} transform hover:scale-105`}
        >
          {buttonText}
        </a>
      </div>
